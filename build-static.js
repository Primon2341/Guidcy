...
const routeMeta = {
  ...
  "/careers": {
    ...
    description: "Explore current career opportunities posted by the Guidcy team and apply to help make expert guidance more accessible.",
    h1: "Careers at Guidcy",
    summary: "View official Guidcy job openings and apply directly through the Guidcy Careers page.",
    priority: "0.8",
    changefreq: "weekly"
  },
  "/career": {
...
["assets/js/core.js","assets/js/app.js"].forEach(minifyDeployableJavaScript);
