...
const routeMeta = {
  ...
  "/find-work": {
    title: "Find Work & Freelance Projects - Guidcy",
    description: "Find freelance work, consulting projects, remote opportunities and professional assignments on Guidcy.",
    h1: "Find Work and Freelance Projects",
    summary: "Explore work opportunities, project-based assignments and consulting work listed by Guidcy users and experts.",
    priority: "0.9",
    changefreq: "daily"
  },
  "/work": {
  ...
  "/become-a-consultant": {
    title: "Join as an Expert Consultant - Guidcy",
    description: "Apply to become a Guidcy consultant, share your expertise, conduct sessions and grow your professional income.",
    h1: "Join Guidcy as an Expert",
    summary: "Create a consultant profile and start offering verified guidance sessions through Guidcy.",
    priority: "0.75"
  },
  "/become": {
    aliasOf: "/become-a-consultant"
  },
  "/about": {
    title: "About Guidcy",
...
if(path.resolve(distDir) !== path.resolve(publicDir)){
  fs.rmSync(distDir, {recursive:true, force:true});
  copyRecursive(publicDir, distDir);
  removeMacDuplicateRouteDirs(distDir);
  console.log("Synced dist from clean public output.");
}
